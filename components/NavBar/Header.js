  ...
  return (
    <motion.div className='flex'>
          ...
          (link) =>
            link.show && (
              <Link passHref href={link.to} key={link.id} scroll={false}>
                <li
                  className={`${
                    activeMenu === link.to ? 'bg-gray-300 dark:bg-gray-900' : ''
      ...
      <div className='md:hidden mr-2 block '>
        ...
        {showMenu && (
          <div className='absolute right-0 w-57 mr-4 mt-2 origin-top-right bg-white dark:bg-gray-700 divide-y divide-gray-200 dark:divide-gray-600 rounded-md shadow-lg outline-none'>
            <div className='py-1'>
              {links.map(
                (link) =>
                  link.show && (
            ...
            <a aria-label={BLOG.title}>
              <motion.div className='h-6 hover:text-blue-500 dark:hover:text-blue-500 fill-current'>
                <svg
                  ...
                  viewBox="0 0 100 100"
                >
                  <g transform='translate(0.000000,10) scale(0.120000,0.120000)'>
