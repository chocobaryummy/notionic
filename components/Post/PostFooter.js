...
const PostFooter = () => {
  ...
  return (
    <div className='w-full pb-12 justify-between font-medium text-gray-500 dark:text-gray-400'>
      <div className='flex flex-wrap sm:flex-nowrap sm:justify-between items-center justify-center rounded-lg bg-gray-300 dark:bg-gray-700 relative gap-3 px-4 py-3'>
        ...
        <div className='flex flex-wrap gap-3'>
          <Link href={'https://ko-fi.com/N4N3FYZ80'}>
            <button
              className='flex gap-1 bg-gray-300 dark:bg-gray-900 hover:bg-gray-200 dark:hover:bg-gray-700 hover:text-gray-600 dark:hover:text-gray-300 text-sm rounded-lg px-4 py-2'
            >
          ...
          <button
            ...
            className='flex gap-1 bg-gray-300 dark:bg-gray-900 hover:bg-gay-00 dark:hover:bg-gray-700 hover:text-gray-600 dark:hover:text-gray-300 text-sm rounded-lg px-4 py-2'
          >
