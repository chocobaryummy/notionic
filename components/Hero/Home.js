        ...
        <div className='flex flex-col md:w-3/5 md:items-start mb-6 md:mb-0 text-left'>
          ...
          <div className='flex flex-col sm:flex-row sm:justify-center gap-4 mt-6'>
            <Link passHref href='/contact' scroll={false}>
              <button className='bg-white-900 dark:bg-blue-700 hover:bg-gray-200 dark:hover:bg-blue-300 inline-flex py-3 px-5 rounded-lg items-center'>
            ...
            {showCopied ? (
              ...
              <button
                onClick={() => clickCopy()}
                className='bg-white-900 dark:bg-blue-700 hover:bg-gray-200 dark:hover:bg-blue-300 inline-flex py-3 px-5 rounded-lg items-center'
              >
